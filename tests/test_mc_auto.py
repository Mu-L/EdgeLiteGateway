...
class TestAutoSmoke:
    ...
    def test_get_conn_state_callable(self):
        ...
        assert obj is not None, (
            f'{_MODULE} 中解析不到 get_conn_state：模块属性与所有类属性表均未命中，'
            f'请确认 API 是否已删除或改名')
        assert callable(obj) or isinstance(obj, property), (
            f'{_MODULE}.get_conn_state 不可调用 (owner={owner!r})')
    ...
    def test_get_degrade_interval_callable(self):
        ...
        assert obj is not None, (
            f'{_MODULE} 中解析不到 get_degrade_interval：模块属性与所有类属性表均未命中，'
            f'请确认 API 是否已删除或改名')
        assert callable(obj) or isinstance(obj, property), (
            f'{_MODULE}.get_degrade_interval 不可调用 (owner={owner!r})')
    ...
    def test_start_upload_callable(self):
        ...
        assert obj is not None, (
            f'{_MODULE} 中解析不到 start_upload：模块属性与所有类属性表均未命中，'
            f'请确认 API 是否已删除或改名')
        assert callable(obj) or isinstance(obj, property), (
            f'{_MODULE}.start_upload 不可调用 (owner={owner!r})')

    def test_stop_upload_callable(self):
        owner, obj = _auto_resolve('stop_upload')
        assert obj is not None, (
            f'{_MODULE} 中解析不到 stop_upload：模块属性与所有类属性表均未命中，'
            f'请确认 API 是否已删除或改名')
        assert callable(obj) or isinstance(obj, property), (
            f'{_MODULE}.stop_upload 不可调用 (owner={owner!r})')
    ...
    def test_get_storage_stats_callable(self):
        ...
        assert obj is not None, (
            f'{_MODULE} 中解析不到 get_storage_stats：模块属性与所有类属性表均未命中，'
            f'请确认 API 是否已删除或改名')
        assert callable(obj) or isinstance(obj, property), (
            f'{_MODULE}.get_storage_stats 不可调用 (owner={owner!r})')
    ...
    def test_get_ota_progress_callable(self):
        ...
        assert obj is not None, (
            f'{_MODULE} 中解析不到 get_ota_progress：模块属性与所有类属性表均未命中，'
            f'请确认 API 是否已删除或改名')
        assert callable(obj) or isinstance(obj, property), (
            f'{_MODULE}.get_ota_progress 不可调用 (owner={owner!r})')
