...
class TestAutoSmoke:
    ...
    def test_success_rate_callable(self):
        ...
        assert obj is not None, (
            f'{_MODULE} 中解析不到 success_rate：模块属性与所有类属性表均未命中，'
            f'请确认 API 是否已删除或改名')
        assert callable(obj) or isinstance(obj, property), (
            f'{_MODULE}.success_rate 不可调用 (owner={owner!r})')
    ...
    def test_get_failover_info_callable(self):
        ...
        assert obj is not None, (
            f'{_MODULE} 中解析不到 get_failover_info：模块属性与所有类属性表均未命中，'
            f'请确认 API 是否已删除或改名')
        assert callable(obj) or isinstance(obj, property), (
            f'{_MODULE}.get_failover_info 不可调用 (owner={owner!r})')

    def test_init_edge_rules_callable(self):
        owner, obj = _auto_resolve('init_edge_rules')
        assert obj is not None, (
            f'{_MODULE} 中解析不到 init_edge_rules：模块属性与所有类属性表均未命中，'
            f'请确认 API 是否已删除或改名')
        assert callable(obj) or isinstance(obj, property), (
            f'{_MODULE}.init_edge_rules 不可调用 (owner={owner!r})')
    ...
    def test_hot_reload_rules_callable(self):
        ...
        assert obj is not None, (
            f'{_MODULE} 中解析不到 hot_reload_rules：模块属性与所有类属性表均未命中，'
            f'请确认 API 是否已删除或改名')
        assert callable(obj) or isinstance(obj, property), (
            f'{_MODULE}.hot_reload_rules 不可调用 (owner={owner!r})')

    def test_evaluate_point_rules_callable(self):
        owner, obj = _auto_resolve('evaluate_point_rules')
        assert obj is not None, (
            f'{_MODULE} 中解析不到 evaluate_point_rules：模块属性与所有类属性表均未命中，'
            f'请确认 API 是否已删除或改名')
        assert callable(obj) or isinstance(obj, property), (
            f'{_MODULE}.evaluate_point_rules 不可调用 (owner={owner!r})')
    ...
    def test_get_edge_rule_stats_callable(self):
        ...
        assert obj is not None, (
            f'{_MODULE} 中解析不到 get_edge_rule_stats：模块属性与所有类属性表均未命中，'
            f'请确认 API 是否已删除或改名')
        assert callable(obj) or isinstance(obj, property), (
            f'{_MODULE}.get_edge_rule_stats 不可调用 (owner={owner!r})')

    def test_init_data_persistence_callable(self):
        owner, obj = _auto_resolve('init_data_persistence')
        assert obj is not None, (
            f'{_MODULE} 中解析不到 init_data_persistence：模块属性与所有类属性表均未命中，'
            f'请确认 API 是否已删除或改名')
        assert callable(obj) or isinstance(obj, property), (
            f'{_MODULE}.init_data_persistence 不可调用 (owner={owner!r})')
    ...
    def test_get_ts_store_stats_callable(self):
        ...
        assert obj is not None, (
            f'{_MODULE} 中解析不到 get_ts_store_stats：模块属性与所有类属性表均未命中，'
            f'请确认 API 是否已删除或改名')
        assert callable(obj) or isinstance(obj, property), (
            f'{_MODULE}.get_ts_store_stats 不可调用 (owner={owner!r})')

    def test_get_offline_sync_stats_callable(self):
        owner, obj = _auto_resolve('get_offline_sync_stats')
        assert obj is not None, (
            f'{_MODULE} 中解析不到 get_offline_sync_stats：模块属性与所有类属性表均未命中，'
            f'请确认 API 是否已删除或改名')
        assert callable(obj) or isinstance(obj, property), (
    ...
    def test_init_enterprise_callable(self):
        ...
        assert obj is not None, (
            f'{_MODULE} 中解析不到 init_enterprise：模块属性与所有类属性表均未命中，'
            f'请确认 API 是否已删除或改名')
        assert callable(obj) or isinstance(obj, property), (
            f'{_MODULE}.init_enterprise 不可调用 (owner={owner!r})')

    def test_check_rbac_callable(self):
        owner, obj = _auto_resolve('check_rbac')
        assert obj is not None, (
            f'{_MODULE} 中解析不到 check_rbac：模块属性与所有类属性表均未命中，'
            f'请确认 API 是否已删除或改名')
        assert callable(obj) or isinstance(obj, property), (
            f'{_MODULE}.check_rbac 不可调用 (owner={owner!r})')

    def test_save_config_version_callable(self):
        owner, obj = _auto_resolve('save_config_version')
        assert obj is not None, (
            f'{_MODULE} 中解析不到 save_config_version：模块属性与所有类属性表均未命中，'
            f'请确认 API 是否已删除或改名')
        assert callable(obj) or isinstance(obj, property), (
            f'{_MODULE}.save_config_version 不可调用 (owner={owner!r})')

    def test_get_config_current_callable(self):
        owner, obj = _auto_resolve('get_config_current')
        assert obj is not None, (
            f'{_MODULE} 中解析不到 get_config_current：模块属性与所有类属性表均未命中，'
            f'请确认 API 是否已删除或改名')
        assert callable(obj) or isinstance(obj, property), (
            f'{_MODULE}.get_config_current 不可调用 (owner={owner!r})')

    def test_get_config_versions_callable(self):
        owner, obj = _auto_resolve('get_config_versions')
        assert obj is not None, (
            f'{_MODULE} 中解析不到 get_config_versions：模块属性与所有类属性表均未命中，'
            f'请确认 API 是否已删除或改名')
        assert callable(obj) or isinstance(obj, property), (
            f'{_MODULE}.get_config_versions 不可调用 (owner={owner!r})')
    ...
    def test_rollback_config_callable(self):
        ...
        assert obj is not None, (
            f'{_MODULE} 中解析不到 rollback_config：模块属性与所有类属性表均未命中，'
            f'请确认 API 是否已删除或改名')
        assert callable(obj) or isinstance(obj, property), (
            f'{_MODULE}.rollback_config 不可调用 (owner={owner!r})')

    def test_get_config_audit_trail_callable(self):
        owner, obj = _auto_resolve('get_config_audit_trail')
        assert obj is not None, (
            f'{_MODULE} 中解析不到 get_config_audit_trail：模块属性与所有类属性表均未命中，'
            f'请确认 API 是否已删除或改名')
        assert callable(obj) or isinstance(obj, property), (
    ...
    def test_ota_check_update_callable(self):
        ...
        assert obj is not None, (
            f'{_MODULE} 中解析不到 ota_check_update：模块属性与所有类属性表均未命中，'
            f'请确认 API 是否已删除或改名')
        assert callable(obj) or isinstance(obj, property), (
            f'{_MODULE}.ota_check_update 不可调用 (owner={owner!r})')

    def test_ota_start_callable(self):
        owner, obj = _auto_resolve('ota_start')
        assert obj is not None, (
            f'{_MODULE} 中解析不到 ota_start：模块属性与所有类属性表均未命中，'
            f'请确认 API 是否已删除或改名')
        assert callable(obj) or isinstance(obj, property), (
            f'{_MODULE}.ota_start 不可调用 (owner={owner!r})')

    def test_ota_rollback_callable(self):
        owner, obj = _auto_resolve('ota_rollback')
        assert obj is not None, (
            f'{_MODULE} 中解析不到 ota_rollback：模块属性与所有类属性表均未命中，'
            f'请确认 API 是否已删除或改名')
        assert callable(obj) or isinstance(obj, property), (
            f'{_MODULE}.ota_rollback 不可调用 (owner={owner!r})')

    def test_ota_get_progress_callable(self):
        owner, obj = _auto_resolve('ota_get_progress')
        assert obj is not None, (
            f'{_MODULE} 中解析不到 ota_get_progress：模块属性与所有类属性表均未命中，'
            f'请确认 API 是否已删除或改名')
        assert callable(obj) or isinstance(obj, property), (
            f'{_MODULE}.ota_get_progress 不可调用 (owner={owner!r})')

    def test_ota_get_history_callable(self):
        owner, obj = _auto_resolve('ota_get_history')
        assert obj is not None, (
            f'{_MODULE} 中解析不到 ota_get_history：模块属性与所有类属性表均未命中，'
            f'请确认 API 是否已删除或改名')
        assert callable(obj) or isinstance(obj, property), (
            f'{_MODULE}.ota_get_history 不可调用 (owner={owner!r})')

    def test_audit_log_callable(self):
        owner, obj = _auto_resolve('audit_log')
        assert obj is not None, (
            f'{_MODULE} 中解析不到 audit_log：模块属性与所有类属性表均未命中，'
            f'请确认 API 是否已删除或改名')
        assert callable(obj) or isinstance(obj, property), (
            f'{_MODULE}.audit_log 不可调用 (owner={owner!r})')
    ...
    def test_get_audit_by_action_callable(self):
        ...
        assert obj is not None, (
            f'{_MODULE} 中解析不到 get_audit_by_action：模块属性与所有类属性表均未命中，'
            f'请确认 API 是否已删除或改名')
        assert callable(obj) or isinstance(obj, property), (
            f'{_MODULE}.get_audit_by_action 不可调用 (owner={owner!r})')
    ...
    def test_batch_write_points_callable(self):
        ...
        assert obj is not None, (
            f'{_MODULE} 中解析不到 batch_write_points：模块属性与所有类属性表均未命中，'
            f'请确认 API 是否已删除或改名')
        assert callable(obj) or isinstance(obj, property), (
            f'{_MODULE}.batch_write_points 不可调用 (owner={owner!r})')
    ...
    def test_get_certificate_status_callable(self):
        ...
        assert obj is not None, (
            f'{_MODULE} 中解析不到 get_certificate_status：模块属性与所有类属性表均未命中，'
            f'请确认 API 是否已删除或改名')
        assert callable(obj) or isinstance(obj, property), (
    ...
    def test_get_collection_mode_callable(self):
        ...
        assert obj is not None, (
            f'{_MODULE} 中解析不到 get_collection_mode：模块属性与所有类属性表均未命中，'
            f'请确认 API 是否已删除或改名')
        assert callable(obj) or isinstance(obj, property), (
            f'{_MODULE}.get_collection_mode 不可调用 (owner={owner!r})')

    def test_get_point_health_stats_callable(self):
        owner, obj = _auto_resolve('get_point_health_stats')
        assert obj is not None, (
            f'{_MODULE} 中解析不到 get_point_health_stats：模块属性与所有类属性表均未命中，'
            f'请确认 API 是否已删除或改名')
        assert callable(obj) or isinstance(obj, property), (
    ...
    def test_get_connection_state_callable(self):
        ...
        assert obj is not None, (
            f'{_MODULE} 中解析不到 get_connection_state：模块属性与所有类属性表均未命中，'
            f'请确认 API 是否已删除或改名')
        assert callable(obj) or isinstance(obj, property), (
            f'{_MODULE}.get_connection_state 不可调用 (owner={owner!r})')
    ...
    def test_datachange_notification_callable(self):
        ...
        assert obj is not None, (
            f'{_MODULE} 中解析不到 datachange_notification：模块属性与所有类属性表均未命中，'
            f'请确认 API 是否已删除或改名')
        assert callable(obj) or isinstance(obj, property), (
    ...
    def test_cancel_callable(self):
        ...
        assert obj is not None, (
            f'{_MODULE} 中解析不到 cancel：模块属性与所有类属性表均未命中，'
            f'请确认 API 是否已删除或改名')
        assert callable(obj) or isinstance(obj, property), (
            f'{_MODULE}.cancel 不可调用 (owner={owner!r})')
