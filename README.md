...
> 详细的修复总报告参见 [docs/ACCEPTANCE_GATE_REPORT.md](docs/ACCEPTANCE_GATE_REPORT.md)。
...
# 跳过 API 检查
python scripts/acceptance_check.py --skip-api
```
...
============================================================
  汇总: API 45/50 通过 (90%) | 前端 20/25 通过 (80%)
  总体: ❌ FAILED
============================================================
```
...
每次提交代码到 GitHub，CI 会自动运行验收检查。在 PR 页面可以看到检查结果。
